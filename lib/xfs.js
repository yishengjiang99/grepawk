    ...
    upload_handler: function (req, res) {
        try {
            ...
            form.parse(req, function (err, fields, files) {
                ...
                if(fields.cwd){
                    containerName = xfs.get_container_name(fields.cwd);
                }
                res.end(`<script>debugger; parent.iframe_interface('uploaded')</script>`);
                blobClient.createBlockBlobFromLocalFile(containerName, files.file.name, files.file.path, options, function (error) {
